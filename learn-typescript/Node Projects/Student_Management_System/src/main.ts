  ...
  while (true) {
    ...
    switch (choice.choice) {
      ...
      case "Enroll Course":
        ...
        studentManager.enroll_course(
          parseInt(course_input.studentId),
      ...
      case "View Student Balance":
        ...
        studentManager.view_student_balance(
          parseInt(balnceInput.studentBalance)
        );
        break;
      ...
      case "Pay Student Fee":
        ...
        studentManager.pay_student_fee(
          parseInt(payFeeInput.studentID),
          parseFloat(payFeeInput.amountInput)
        );
        break;
      ...
      case "Show Student Status":
        ...
        studentManager.show_student_status(
          parseInt(StudentStatusInput.student_ID)
        );
        break;
